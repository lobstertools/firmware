...
For complete details on the HTTP API, including endpoints, data structures, state machine logic, and usage examples, please refer to the **[API Documentation](lobster_lock_api_docs.md)**.
